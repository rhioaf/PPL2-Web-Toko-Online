                ...
                <div class="container">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo base_url('index.php/penjualan') ?>">Penjualan <span class="sr-only">(current)</span></a>
                        </li>
                        <!-- <li class="nav-item">
                                ...
                                <div class="d-flex">
                                    ...
                                    <p style="margin: -2px 0 0 5px">
                                        <?php if(is_null($this->session->userdata('data_cart'))){
                                            ...
                                            echo count($this->session->userdata('data_cart')). ' item';
                                        }
                                        ?>
                                    </p>
                                </div>
