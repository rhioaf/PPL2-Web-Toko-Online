...
<html>
    ...
    <body>
        <div class="container">
            <div class="box-v2">
                <h6 class="mb-4">Silahkan isi sesuai data diri anda</h6>
                <form action="<?= base_url('index.php/auth_register') ?>" method="POST">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="submit" class="btn btn-primary btn-sm mr-3">Daftar</button>
                        <p class="my-auto">Sudah punya akun? Login di <a href="<?= base_url('index.php/login') ?>">sini</a> </p>
                    </div>
                </form>
            </div>
        </div>
